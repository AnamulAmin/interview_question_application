...
import EditKitchenAssign from "../Kitchen/forms/EditKitchenAssign";
...
export default function PendingOrders(): JSX.Element {
  ...
  const handleAssignOrder = async (order: any) => {
    ...
    //       data: { status: "processing", _id: order?._id },
    //     });
              ...
              <TableRow key={order.id}>
                ...
                <TableCell>
                  <div className="flex gap-2 w-full">
                    <Button
                      color="success"
                      onPress={() => handleAssignOrder(order)}
                    >
                      Assign
                    </Button>
                    <Button
                    ...
                    >
                      <Link to={`/edit-pos-invoice/${order._id}`}>
                        <FiEdit />
                      </Link>
                    </Button>
                    <Button

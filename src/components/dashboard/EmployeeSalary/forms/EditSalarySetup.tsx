...
export default function EditSalarySetup({
  setIsShowModal,
  isShowModal,
  setIsRender,
  data,
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await window.ipcRenderer.invoke("update-salary-setup", {
        data: formData,
        id: data._id,
      });
  ...
  return (
    <Modal isOpen={isShowModal} onOpenChange={setIsShowModal} size="4xl">
      <ModalContent>
        ...
        <ModalBody>
          ...
          <Select
            ...
            color="secondary"
            defaultSelectedKeys={[data?.salaryType]}
          >

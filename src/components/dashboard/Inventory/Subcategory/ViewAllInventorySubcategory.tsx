...
import CreateInventorySubcategoryForm from "./CreateInventorySubcategoryForm";
import ShowInventorySubcategoryDetail from "./ShowInventorySubcategoryDetail";
import EditInventorySubcategoryForm from "./EditInventorySubcategoryForm";

export default function ViewAllInventorySubcategory(): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-10">
      ...
      <CreateInventorySubcategoryForm
        setIsShowModal={setIsCreateModalOpen}
        isShowModal={isCreateModalOpen}
      />
      <ShowInventorySubcategoryDetail
        data={singleData}
        isOpen={isOpen}
        onOpenChange={onOpenChange}
      />

      <EditInventorySubcategoryForm

...
interface EditInventoryCategoryFormProps {
  isShowModal: boolean;
  data: any;
  setIsShowModal: (value: boolean) => void;
}

const EditInventoryCategoryForm: React.FC<EditInventoryCategoryFormProps> = ({
  isShowModal,
  data,
  setIsShowModal,
}) => {
...
export default EditInventoryCategoryForm;

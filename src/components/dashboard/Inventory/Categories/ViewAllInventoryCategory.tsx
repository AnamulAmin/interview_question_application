...
import ShowInventoryCategoryDetail from "./ShowInventoryCategoryDetail";
import EditInventoryCategoryForm from "./EditInventoryCategoryForm";
...
export default function ViewAllInventoryCategory(): JSX.Element {
    ...
    <div className="min-h-screen bg-gray-100 p-10">
      <div className="max-w-6xl mx-auto bg-white p-8 shadow-md rounded-md">
        <div className="flex justify-between">
          <h1 className="text-2xl font-bold mb-5">Inventory Category List</h1>

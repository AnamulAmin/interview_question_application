...
import AddFloor from "./forms/AddFloor";
...
export default function ViewAllFloor(): JSX.Element {
    ...
    <div className="min-h-screen bg-gray-100 p-10">
      <div className="max-w-6xl mx-auto bg-white p-8 shadow-md rounded-md">
        <div className="flex justify-between">
          <h1 className="text-2xl font-bold mb-5">Floor List</h1>
          ...
          <TableBody>
            {floors.map((item: any, index: number) => (
              <TableRow key={item._id} className="border-b">
                ...
                <TableCell className="border p-2">{item.floorName}</TableCell>
                <TableCell className="border p-2">
